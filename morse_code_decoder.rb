def decode_char(morse_char)
  ...
  alpha_char = morse_code_dictionary[morse_char]
  alpha_char || '' # If alpha_char is nil, set it to ''
end
...
def morse_code_decode_message(morse_message)
  ...
  decoded_message.strip # Remove trailing spaces and return the decoded message
end
...
puts "Decoded message: #{morse_code_decode_message(morse_code_input)}"
